...
public class EmailUtils {
	public static void sendEmail(User user){
		//发送方
		String myAccount = "467584306@qq.com";
		//授权码
		String myPass = "xldopaxupbfycace";
		//发件人 邮箱的 SMTP 服务器地址
//		String SMTPHost = "smtp.163.com";
		String SMTPHost = "smtp.qq.com";
		//组成 properties
		Properties prop = new Properties();
		prop.setProperty("mail.transport.protocol", "smtp");//设置协议类型  pop3
	...
	private static MimeMessage createMsg(Session session, String myAccount, User user) {
		...
		//3.设置发件人 收件人 标题 邮件内容 附件 发送时间等等
		try {
			//3.1发件人 from  从myAccount邮箱发送邮件 发送人为小米
			...
			String url = "http://"+ip+":8080/myshop/UserController?method=activate&e="+ Base64Utils.encode(user.getEmail())
					+"&c="+Base64Utils.encode(user.getCode());
