...
<script type="text/javascript">
	$(function(){
		$("#username").change(function(){
			$.get("UserController?method=checkName&username="+this.value,function(data){
				if(data==1){
			...
			$("form").validate({
				rules:{
					...
					//upassword:{required:true,digits:true,rangelength:[3,6]},
					//rupassword:{required:true,digits:true,rangelength:[3,6]},
					emile:{required:true,email:true}
				},
				messages:{
					username:{required:"用户名不能为空"},
					//upassword:{required:"密码不能为空"},
					//rupassword:{required:"确认密码不能为空"},
					emile:{required:"邮箱不能为空"}
				}
	...
	<div class="regist">
		<div class="regist_center">
			...
			<div class="center-block" style="margin-top: 80px;">
				<form class="form-horizontal" action="UserController?method=reg" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-8" style="width: 40%">
							<input type="password" name="rupassword" class="form-control col-sm-10"
