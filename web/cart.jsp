...
<script type="text/javascript">
	...
	function sub(cid,cnum,price){
		...
		if (cnum == 1){
			...
			{
				location.href = "cart?method=delCart&cid="+cid;
			}
		}else{
			cnum--;
			location.href = "cart?method=updateNum&cid="+cid+"&cnum="+cnum+"&price="+price+"&num=1";
		}
	...
	function add(cid,cnum,price){
		cnum++;
		location.href = "cart?method=updateNum&cid="+cid+"&cnum="+cnum+"&price="+price+"&num=2";
	}
