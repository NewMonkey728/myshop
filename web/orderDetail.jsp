	...
	<table cellpadding="0" cellspacing="0" align="center" width="100%" class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<td>
				...
				<fmt:formatDate value="${orders.otime}" pattern="yyyy-MM-dd HH-mm-ss"></fmt:formatDate>
			</td>
		</tr>
		<tr>
			<td>收件人:</td>
		...
		<tr>
			<td align="right" colspan="4" style="margin-right: 40px;">
				<a href="${pageContext.request.contextPath }/order?method=getOrderList" class="btn btn-danger btn-sm">返回订单列表</a>
				&nbsp;&nbsp;
